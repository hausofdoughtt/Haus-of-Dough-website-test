...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-100 text-stone-900">
      ...
      <main>
        <section className="max-w-7xl mx-auto px-5 py-16 grid lg:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .6 }}>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button className="rounded-full bg-pink-500 hover:bg-pink-600 text-white px-7 py-6 text-base">Shop Cookies</Button>
              <Button variant="outline" className="rounded-full border-pink-200 px-7 py-6 text-base">Build a Box</Button>
            </div>
          </motion.div>
        ...
        <section id="cookies" className="max-w-7xl mx-auto px-5 py-10">
        ...
        <section id="boxes" className="max-w-7xl mx-auto px-5 py-14">
          <div className="rounded-[2rem] bg-white/80 border border-pink-100 shadow-xl p-6 md:p-8">
            ...
            <Button onClick={addBoxToCart} disabled={!boxComplete} className="mt-7 rounded-full bg-stone-900 hover:bg-stone-700 px-8 py-6 disabled:opacity-40">Add {activeBox.name} to Cart</Button>
          </div>
        </section>

        <section id="order" className="max-w-7xl mx-auto px-5 py-12 grid lg:grid-cols-3 gap-6">
